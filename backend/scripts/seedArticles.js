...
const articlesData = {
  ...
  "articles": [
    ...
    {
      "id": 2,
      "title": "Understanding Childhood Vaccinations: A Complete Guide for Parents",
      "category": "Health",
      "image": "https://images.unsplash.com/photo-1584036561566-baf8f5f1b144?w=800&h=500&fit=crop&q=80",
      "image1": "https://images.unsplash.com/photo-1631815588090-d4bfec5b1ccb?w=800&h=500&fit=crop&q=80",
      "description": "Everything parents need to know about childhood immunizations, vaccine schedules, and protecting your children from preventable diseases.",
      "content": "Vaccinations are one of the most important ways to protect your child's health. The recommended vaccine schedule protects children from 14 serious diseases before age 2. Vaccines work by teaching the immune system to recognize and fight diseases. Common childhood vaccines include DTaP (diphtheria, tetanus, pertussis), MMR (measles, mumps, rubella), polio, hepatitis B, and chickenpox vaccines. Side effects are usually mild, such as soreness at the injection site or low-grade fever. Serious side effects are extremely rare. Talk to your pediatrician about any concerns you have. Staying on schedule with vaccinations is crucial because babies are most vulnerable to disease in their first years of life. Many vaccines require multiple doses to build full immunity. Keep accurate records of your child's vaccinations for school enrollment and travel. If you've missed appointments, catch-up schedules are available. Remember that vaccinating your child also protects others in your community who may be too young or unable to be vaccinated themselves.",
    ...
    },
    {
      ...
      "image1": "https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=800&h=500&fit=crop&q=80",
      "description": "Start your child's dental health journey right with proper care from the very first tooth through early childhood.",
      "content": "Good dental habits begin early. Clean your baby's gums with a soft, damp cloth even before teeth appear. When the first tooth erupts (usually around 6 months), begin brushing twice daily with a soft-bristled toothbrush and water. Use a rice-grain-sized smear of fluoride toothpaste once teeth touch each other. Increase to a pea-sized amount at age 3. Schedule the first dental visit by age 1 or within 6 months of the first tooth appearing. Early visits help children become comfortable with the dentist and catch potential problems early. Never put a baby to bed with a bottle—milk or juice pooling around teeth causes decay. Transition from bottle to cup by 12-18 months. Limit sugary foods and drinks. Offer water between meals instead of juice or milk. Teach children to brush for 2 minutes twice daily—use songs or timers to make it fun. Parents should brush until age 6-7 when children have the dexterity to do it properly. Don't forget to floss once teeth touch! Fluoride strengthens teeth and prevents cavities. Ask your dentist if your water supply contains fluoride or if supplements are needed. Protect teeth during sports with mouthguards. Address thumb-sucking or pacifier use by age 3-4 to prevent dental problems. Baby teeth matter—they hold space for permanent teeth and affect speech development.",
    ...
    {
      "id": 7,
      "title": "Building Strong Immunity: Supporting Your Child's Health Naturally",
      "category": "Health",
    ...
    {
      "id": 17,
      "title": "Budgeting for Baby: First-Year Financial Planning for New Parents",
      "category": "Finances",
    ...
    {
      "id": 18,
      "title": "Saving for College: 529 Plans and Other Education Savings Strategies",
      "category": "Finances",
      ...
      "description": "Start early and save smart for your child's education with tax-advantaged accounts, investment strategies, and realistic goal-setting.",
    ...
    {
      "id": 21,
      "title": "Morning Routines That Work: Getting Out the Door with Less Stress",
      "category": "Routines",
    ...
    {
      "id": 24,
      "title": "After-School Routines: Balancing Homework, Activities, and Downtime",
      "category": "Routines",
    ...
    {
      "id": 25,
      "title": "Weekend Routines: Balancing Structure and Flexibility for Family Time",
      "category": "Routines",
    ...
    {
      "id": 26,
      "title": "Positive Discipline Strategies That Work Without Yelling or Punishment",
      "category": "Parenting",
