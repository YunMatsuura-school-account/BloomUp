  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl max-w-md w-full p-6">
        <h3 className="text-[15px] md:text-xl font-semibold text-gray-800 mb-4 font-sans">Edit Expense</h3>
...
const calculateMonthlySpendingDataFallback = () => {
  ...
  const getChartData = () => {
    ...
    if (monthlySpending.length === 0 || !hasData) {
      const ghostHeights = [1200, 900, 1500, 1800, 1300, 2000, 1600, 1100, 1700, 1400, 1900, 1000];
      return {
        labels: monthNames,
        datasets: [
          {
    ...
    return (
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="bg-white p-6 rounded-xl max-w-md text-center">
          <div className="text-[15px] md:text-lg text-red-600 mb-4 font-sans font-semibold">Error loading budget</div>
          <div className="text-[12px] md:text-sm text-gray-600 mb-4 font-sans">{error}</div>
          <button
            ...
            {!hasData && (
              <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                <div className="text-center">
                  ...
                  <div className="text-[15px] md:text-xl font-semibold text-gray-800 mb-1 font-sans">No data yet to show!</div>
                  <div className="text-[12px] md:text-sm text-gray-500 font-sans">Please add your details first</div>
                </div>
              </div>
            )}
            ...
            {expenses.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center py-8">
                <div className="text-center mb-6">
                  ...
                  <div className="text-[15px] md:text-lg font-semibold text-gray-800 mb-2 font-sans">No expenses recorded yet!</div>
                  <div className="text-[12px] md:text-sm text-gray-500 font-sans">Start by adding your first expense by using options below</div>
                </div>

                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <button 
                    onClick={() => navigate("/dashboard/budget/add-manual")} 
                    className="flex justify-center items-center min-w-[180px] h-[54px] gap-[10px] rounded-[15px] text-black font-sans text-[12px] md:text-[16px] font-[600] leading-[140%] cursor-pointer border-none px-6 transition-colors whitespace-nowrap"
                  >
                    Add manually
                  </button>
                  <button 
              ...
              <>
                ...
                {filteredExpenses.length === 0 ? (
                  <div className="text-center py-16">
                    ...
                    <div className="text-[15px] md:text-lg font-semibold text-gray-800 mb-2 font-sans">No matching expenses found</div>
                    <div className="text-[12px] md:text-sm text-gray-500 font-sans">Try adjusting your search query or <button onClick={() => setSearchQuery('')} className="text-[#238D88] hover:text-[#1a6d69] underline bg-transparent border-none cursor-pointer p-0 font-medium">clear the search</button></div>
                  </div>
                ) : (
                  <>
              ...
              />
                    ...
                    <div className="md:hidden flex-1 overflow-hidden">
                      <div className="overflow-y-auto" style={{ maxHeight: 'calc(647px - 180px)' }}>
                        <div className="space-y-4">
                          {filteredExpenses.map((expense, index) => (
                            <div key={expense.id} className="rounded-lg shadow-sm p-4 border border-gray-200">
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                <div className="text-sm text-gray-600 font-sans">
                                  ...
                                  <div className="text-black">{expense.merchantName}</div>
        ...
        <div className="bg-[#FAFAFA] rounded-xl p-6">
          {!aiInsights || (!aiInsights.immediateAlerts?.length && !aiInsights.budgetAlerts?.length && 
            ...
            <div className="flex flex-col items-center mb-4 gap-3">
              ...
              <h3 className="text-base font-semibold text-[15px] md:text-[25px] m-0 font-sans text-center">AI Insights & Suggestions</h3>
            </div>
          ) : (
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-[24px] h-[24px] rounded-full bg-[rgba(255,20,20,0.24)] flex items-center justify-center flex-shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path d="M6.21151 0.445065C6.50439 -0.111419 7.26968 -0.145958 7.62166 0.340898L7.68677 0.445065L13.8014 12.0629C14.0932 12.6178 13.6907 13.2842 13.0637 13.2843H0.834555C0.20755 13.2842 -0.194956 12.6178 0.0969246 12.0629L6.21151 0.445065ZM1.1106 12.2843H12.7877L6.94914 1.19181L1.1106 12.2843Z" fill="#FF1B00"/>
                        <path d="M6.44922 8.11751V4.78418C6.44922 4.50804 6.67308 4.28418 6.94922 4.28418C7.22536 4.28418 7.44922 4.50804 7.44922 4.78418V8.11751C7.44922 8.39366 7.22536 8.61751 6.94922 8.61751C6.67308 8.61751 6.44922 8.39366 6.44922 8.11751Z" fill="#FF1B00"/>
                        <path d="M7.33333 10.6667C7.33333 11.0349 7.03486 11.3333 6.66667 11.3333C6.29848 11.3333 6 11.0349 6 10.6667C6 10.2985 6.29848 10 6.66667 10C7.03486 10 7.33333 10.2985 7.33333 10.6667Z" fill="#FF1B00"/>
                      </svg>
                    </div>
                    <h4 className="text-[14px] font-semibold text-gray-800 font-sans">Immediate Alert</h4>
                  </div>
                ...
                <div className="p-4 bg-[rgba(243,190,8,0.13)] border border-[#F3BE08] rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-[24px] h-[24px] rounded-full bg-[rgba(255,202,31,0.42)] flex items-center justify-center flex-shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path d="M12.3333 6.66667C12.3333 3.53705 9.79628 1 6.66667 1C3.53705 1 1 3.53705 1 6.66667C1 9.79628 3.53705 12.3333 6.66667 12.3333V13.3333C2.98477 13.3333 0 10.3486 0 6.66667C0 2.98477 2.98477 0 6.66667 0C10.3486 0 13.3333 2.98477 13.3333 6.66667C13.3333 10.3486 10.3486 13.3333 6.66667 13.3333V12.3333C9.79628 12.3333 12.3333 9.79628 12.3333 6.66667Z" fill="#FF9900"/>
                        <path d="M6.16699 2.6665C6.16699 2.39036 6.39085 2.1665 6.66699 2.1665C6.94313 2.1665 7.16699 2.39036 7.16699 2.6665V6.45947L9.02051 8.31299C9.21577 8.50825 9.21577 8.82476 9.02051 9.02002C8.82525 9.21528 8.50874 9.21528 8.31348 9.02002L6.41113 7.11768C6.25486 6.96141 6.16701 6.74948 6.16699 6.52848V2.6665Z" fill="#FF9900"/>
                      </svg>
                    </div>
                    <h4 className="text-[14px] font-semibold text-gray-800 font-sans">Budget Alert</h4>
                  </div>
                ...
                <div className="p-4 bg-[rgba(12,198,142,0.17)] border border-[#0CC68E] rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-[24px] h-[24px] rounded-full bg-[rgba(0,166,116,0.26)] flex items-center justify-center flex-shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                        <path d="M2.08301 2.0835V13.1946C2.08301 13.563 2.22934 13.9162 2.4898 14.1767C2.75027 14.4372 3.10354 14.5835 3.4719 14.5835H14.583M13.1941 6.25016L9.7219 9.72238L6.94412 6.94461L4.86079 9.02794" stroke="#238D88" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                    </div>
                    <h4 className="text-[14px] font-semibold text-gray-800 font-sans">Predictive Alert</h4>
                  </div>
              ...
              {aiInsights.smartShopping?.length > 0 && (
                <div className="p-4 bg-[rgba(0,115,231,0.11)] border border-[#0073E7] rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-[14px] font-semibold text-gray-800 font-sans">Smart Shopping</h4>
                  </div>
