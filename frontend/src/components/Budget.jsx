    ...
    <div className="mb-6 bg-white rounded-lg p-5 shadow-sm">
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="text-[12px] md:text-[16px] text-gray-600 font-sans flex flex-col gap-1">
          Total Allocated:{" "}
          <span className="font-semibold text-[12px] md:text-[32px] font-numbers">
            ${overview.total}
          </span>
        </div>
      </div>
  ...
  if (loading) {
    return (
      <div className="bg-gray-100 min-h-screen flex items-center justify-center">
        <div className="text-[15px] md:text-lg text-gray-600 font-sans">
          Loading budget...
        </div>
      </div>
    );
      ...
      <div className="p-5">
        ...
        <div className="bg-[#FAFAFA] rounded-xl p-6 mb-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <h2 className="text-[15px] md:text-[25px] font-semibold text-gray-800 m-0 font-sans">
              Budget Overview
            </h2>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-5 text-center shadow-[1px_1px_10px_0_rgba(0,0,0,0.25)]">
              <div className="text-[15px] md:text-[20px] text-gray-600 mb-2 font-sans font-medium">
                Total Budget
              </div>
              <div className="text-[19px] md:text-[40px] font-semibold text-gray-800 font-numbers">
                ${overview.total?.toFixed(2) || "0.00"}
              </div>
            </div>
            <div className="bg-white rounded-lg p-5 text-center shadow-[1px_1px_10px_0_rgba(0,0,0,0.25)]">
              <div className="text-[15px] md:text-[20px] mb-2 font-sans font-medium text-[#F39D08]">
                Budget Spent
              </div>
              <div className="text-[19px] md:text-[40px] font-semibold text-[#F39D08] font-numbers">
                ${overview.spent?.toFixed(2) || "0.00"}
              </div>
            </div>
            <div className="bg-white rounded-lg p-5 text-center shadow-[1px_1px_10px_0_rgba(0,0,0,0.25)]">
              <div className="text-[15px] md:text-[20px] mb-2 font-sans font-medium text-[#238D88]">
                Remaining
              </div>
              <div className="text-[19px] md:text-[40px] font-semibold text-[#238D88] font-numbers">
                ${overview.remaining?.toFixed(2) || "0.00"}
              </div>
              {overview.total > 0 && (
                <div className="text-xs mt-2 font-sans font-medium text-[#238D88]">
                  {overview.status}
                </div>
              )}
            </div>
        ...
        <div
          className="rounded-[15px] mb-6 bg-[#FAFAFA]"
            ...
            <div className="flex items-center justify-between mb-4 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <h3 className="text-[15px] md:text-[25px] font-semibold text-gray-800 m-0 font-sans">
                    AI Insights & Suggestions
                  </h3>
                  {insightsLoading && (
